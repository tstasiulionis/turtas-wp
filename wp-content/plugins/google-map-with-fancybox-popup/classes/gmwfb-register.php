...
function gmwfb_add_javascript_files() 
{
	if (!is_admin())
	{
		...
		wp_enqueue_style( 'jquery.fancybox-1.3.4', GMWFB_URL.'inc/jquery.fancybox.min.css');
		wp_enqueue_script('jquery.fancybox-1.3.4', GMWFB_URL.'inc/jquery.fancybox.min.js');
	}
}
?>