...
<div class="wrap">
  <div id="icon-edit" class="icon32 icon32-posts-post"></div>
	...
	<?php
	  ...
	  <div class="tablenav">
	  <a href="<?php echo GMWFB_ADMINURL; ?>&amp;ac=add"><input class="button action" type="button" value="<?php _e('Add New', 'google-map-with-fancybox-popup'); ?>" /></a>
	  <a target="_blank" href="<?php echo GMWFB_FAV; ?>"><input class="button action" type="button" value="<?php _e('Help', 'google-map-with-fancybox-popup'); ?>" /></a>
	  </div>
